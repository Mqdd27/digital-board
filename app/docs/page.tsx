    ...
    client_max_body_size 12M;   # attachments are capped at 10 MB
          ...
          <Table
            ...
            rows={[
              ...
              [<strong className="text-foreground">Canvas</strong>, <>tldraw with sheet tabs. Each sheet keeps its own drawing, saved as you draw; switching sheets never disturbs another one.</>],
